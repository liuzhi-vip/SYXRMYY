		...
		<form class="form form-horizontal" id="form-article-add">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<input type="file" name="article_img" accept="image/*" id="file" multiple>
					</a>
					<div class="img_">
						实时预览: <br />
						<div class="imgs"></div>
...
if(filePath!=""){
	filegth=document.getElementById("file").files.length;//文件个数
	for(var i=0;i<filegth;i++){
// 		alert(document.getElementById("file").files[i]=null)
		var files = document.getElementById("file").files[i];//读取文件
		var r= new FileReader();
		r.readAsDataURL(files);
			r.onloadend = function () {    
	  			 $(".imgs").html($(".imgs").html()+'<div><img class="img_preview" id="'+i+'" alt="图片预览" src="'+this.result+'"><i class="Hui-iconfont">&#xe609;</i></div>')
	   			 $(".img_").show();
							}    
