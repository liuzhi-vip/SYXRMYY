...
<body>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				data-href="article-add.jsp" onclick="Hui_admin_tab(this)"
	...
	function getDateTime(date) {
		...
		$('.table-sort').dataTable({
			"ajax" : {
					url:"admin/article_queryAllArticle",
					cache:false,
					type:"post",
					dataType:"json",
					dataSrc:"",//默认为data,这里定义为空，则只需要传不带属性的数据[{xxx}]这就是不带属性 [xx{xxx}]这就是带xx属性
				},
			...
			"columns" : [
				{"data":null,
					...
					var html='<input type="checkbox" value="'+data.article_id+'" name="">';
					return html;
				}
				},
				{"data":"article_id"},
				{"data":"article_title"},
				{"data":"article_classsify"},
				{"data":"article_source"},
				{"data":"article_publishtime"},
				{"data":"article_hits"},
				{"data":"article_state"},
				{"data":"article_state"}
			],
